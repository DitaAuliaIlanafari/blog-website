...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      />
      and I want to disscus and I want to discuss a potential project. You can
      email me at
      <input
        type="email"
      ...
      <input
        type="submit"
        value="send request"
        className="mt-8 font-medium inline-block capitalize text-lg sm:text-xl pt-2 sm:py-3  px-6 sm:px-8 border-2 border-solid border-dark rounded cursor-pointer"
      />
    </form>
  );
}
